 ...
 * @author HP
 */
public class ExpiredDataObat extends javax.swing.JFrame {
       ...
       try{
          Statement state  = Koneksi.getConnection().createStatement();
           Rs = state.executeQuery("SELECT\n" +
                                    ...
                                    "WHERE tb_beli_detail.expired_date <= '"+tanggal+"'");
           while(Rs.next()){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("DATA OBAT EXPIRED");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpiredDataObat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExpiredDataObat().setVisible(true);
            }
        });
    }
